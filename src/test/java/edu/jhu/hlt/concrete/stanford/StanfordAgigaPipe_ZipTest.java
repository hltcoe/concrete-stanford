...
public class StanfordAgigaPipe_ZipTest {
  ...
  // sect.getSentenceSegmentationList().get(0) != null) {
  ...
  // int end = 242;
  // Sentence sent =
  // StanfordAgigaPipe_AFP0623Test.processedComm.getSectionSegmentationList().get(0).getSectionList().get(1).getSentenceSegmentationList().get(0).getSentenceList().get(0);
  ...
  // if(nsect.getSentenceSegmentationList() == null) continue;
  // for(Sentence nsent : nsect.getSentenceSegmentationList().get(0).getSentenceList()){
